...
# wandb.init(project="baseline meso4 Face2Face",  entity="seanko96")
...
TRAIN_PATH = '/home/data/deepfake_privacy/FF_original/FaceForensics++/FaceSwap/train'
VAL_PATH = '/home/data/deepfake_privacy/FF_original/FaceForensics++/FaceSwap/test/'
...
for epoch in range(num_epochs):
    ...
    if best_val_acc < val_epoch_acc:
        if epoch == 0:
            ...
            torch.save(model.module.state_dict(), os.path.join(SAVE_PATH, f'{DATASET_NAME}_{MODEL_NAME}_best_epoch_{epoch}_{dp_method}.pth'))
            print("model saved!!")
        else:
            os.remove(os.path.join(SAVE_PATH, f'{DATASET_NAME}_{MODEL_NAME}_best_epoch_{best_epoch}_{dp_method}.pth'))
            best_epoch=epoch
            best_val_acc = val_epoch_acc
            torch.save(model.module.state_dict(), os.path.join(SAVE_PATH, f'{DATASET_NAME}_{MODEL_NAME}_best_epoch_{best_epoch}_{dp_method}.pth'))
            print("model_updated!!")
